...
public class ArtistaController {
    ...
    @GetMapping("/buscar")
    public ArtistaEntity buscarArtista(@RequestParam(name = "id") Integer id) {
        return artistaService.buscar(id);
    }

    @PostMapping("/criar")
    public ResponseEntity<ArtistaEntity> criarArtista(@RequestBody ArtistaEntity artista) {
    ...
    public String apagarArtista(@RequestParam(name = "id") Integer id) {
